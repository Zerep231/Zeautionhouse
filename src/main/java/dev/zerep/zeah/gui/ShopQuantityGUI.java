    ...
    private void render() {
        ...
        inventory.setItem(13, buildItem(shopItem.getMaterial(),
            ...
            List.of(
                ...
                "&7Total:      &a" + plugin.getCurrencyManager().format(shopItem.getPrice() * quantity, shopItem.getCurrencyId()),
                "",
                "&7Your balance: &e" + plugin.getCurrencyManager().format(plugin.getCurrencyManager().getBalance(player, shopItem.getCurrencyId()), shopItem.getCurrencyId())
            )));
        ...
        inventory.setItem(22, buildItem(Material.EMERALD, "&a&lConfirm",
            List.of("&7Total: &e" + plugin.getCurrencyManager().format(shopItem.getPrice() * quantity, shopItem.getCurrencyId()))));
